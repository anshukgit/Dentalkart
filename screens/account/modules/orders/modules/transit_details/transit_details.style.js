...
export default styles = StyleSheet.create({
    ...
    shippingAddressView: { width: '100%', minHeight: 65, paddingHorizontal: 20, justifyContent: 'space-evenly', backgroundColor: colors.white, marginBottom: 6,paddingVertical:3},
    shippingAddressText: { fontSize: 14, color: colors.black, fontWeight: '600' },
    address: { fontSize: 11, color: '#9d9d9d', fontWeight: '400' },
    ...
    billMainView: { minHeight: 100, backgroundColor: colors.white, justifyContent: 'center', paddingHorizontal: 20, marginBottom: 2 },
